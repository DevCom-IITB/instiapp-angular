  ...
  return (function (t) {
    ...
    function (t, e) {
      ...
      function l() {
        f &&
          u &&
          ((f = !1), u.length ? (h = u.concat(h)) : (c = -1), h.length && p());
      }
      function p() {
        if (!f) {
          var t = a(l);
    ...
    function (t, e, n) {
      ...
      (function (t) {
        var r = n(11);
        e.a = function (e, n, i) {
          if (!i.crypto || "function" !== typeof i.crypto.createHmac)
            throw new Error(
              "Expecting options.crypto to have a createHmac function"
            );
          if ("function" !== typeof i.createHmacSecret)
            throw new Error(
              "Expecting options.createHmacSecret to be a function"
            );
          if ("string" !== typeof i.algorithm)
    ...
    function (t, e, n) {
      ...
      (function (e, r, i) {
        ...
        function _(t, e) {
          ...
          (this.highWaterMark = i || 0 === i ? i : r && (h || 0 === h) ? h : f),
        ...
        function b(t) {
          if (((a = a || n(4)), !(d.call(b, this) || this instanceof a)))
            return new b(t);
          (this._writableState = new _(t, this)),
            (this.writable = !0),
            t &&
          ...
          if (t._writev && n && n.next) {
            ...
            for (; n; ) {
              var h = n.chunk,
                ...
                c = n.callback;
              if (
                (v(t, e, !1, e.objectMode ? 1 : h.length, h, f, c),
                (n = n.next),
            ...
            ? ((d = Function.prototype[Symbol.hasInstance]),
              Object.defineProperty(b, Symbol.hasInstance, {
                value: function (t) {
                  return (
                    !!d.call(this, t) ||
                    (this === b && t && t._writableState instanceof _)
                  );
                },
              }))
            : (d = function (t) {
        ...
        (v.prototype.read = function (t) {
          ...
          if (
            ...
            return (
              ...
              0 === e.length && e.ended ? L(this) : k(this),
              null
            );
          ...
          (v.prototype.on = function (t, e) {
            ...
            if ("data" === t)
              ...
              r.endEmitted ||
                ...
                (r.emittedReadable = !1),
                r.reading ? r.length && k(this) : i.nextTick(A, this));
            }
            return n;
          }),
          ...
          (v.prototype.resume = function () {
            ...
            return (
              t.flowing ||
                ...
                (function (t, e) {
                  e.resumeScheduled ||
                    ((e.resumeScheduled = !0), i.nextTick(R, t, e));
                })(this, t)),
              this
            );
          }),
      ...
      r(u, i),
        ...
        (u.prototype._update = function (t) {
          ...
          (this._al = (this._al + w) | 0),
            ...
            (this._ah = (this._ah + n + _(this._al, w)) | 0),
            (this._bh = (this._bh + r + _(this._bl, m)) | 0),
            (this._ch = (this._ch + i + _(this._cl, E)) | 0),
            (this._dh = (this._dh + o + _(this._dl, S)) | 0),
            (this._eh = (this._eh + a + _(this._el, k)) | 0),
            (this._fh = (this._fh + u + _(this._fl, T)) | 0),
            (this._gh = (this._gh + b + _(this._gl, x)) | 0),
            (this._hh = (this._hh + v + _(this._hl, O)) | 0);
        }),
        (u.prototype._hash = function () {
        ...
        r(s, i),
          (s.prototype._update = function () {
            ...
            var n = this._a,
              ...
              i = this._c,
              s = this._d;
            (n = u(n, r, i, s, t[0], 3614090360, 7)),
              (s = u(s, n, r, i, t[1], 3905402710, 12)),
              (i = u(i, s, n, r, t[2], 606105819, 17)),
              (r = u(r, i, s, n, t[3], 3250441966, 22)),
              (n = u(n, r, i, s, t[4], 4118548399, 7)),
              (s = u(s, n, r, i, t[5], 1200080426, 12)),
              (i = u(i, s, n, r, t[6], 2821735955, 17)),
              (r = u(r, i, s, n, t[7], 4249261313, 22)),
              (n = u(n, r, i, s, t[8], 1770035416, 7)),
              (s = u(s, n, r, i, t[9], 2336552879, 12)),
              (i = u(i, s, n, r, t[10], 4294925233, 17)),
              (r = u(r, i, s, n, t[11], 2304563134, 22)),
              (n = u(n, r, i, s, t[12], 1804603682, 7)),
              (s = u(s, n, r, i, t[13], 4254626195, 12)),
              (i = u(i, s, n, r, t[14], 2792965006, 17)),
              (n = h(
                n,
                (r = u(r, i, s, n, t[15], 1236535329, 22)),
                i,
                s,
                t[1],
                4129170786,
              ...
              (s = h(s, n, r, i, t[6], 3225465664, 9)),
              (i = h(i, s, n, r, t[11], 643717713, 14)),
              (r = h(r, i, s, n, t[0], 3921069994, 20)),
              (n = h(n, r, i, s, t[5], 3593408605, 5)),
              (s = h(s, n, r, i, t[10], 38016083, 9)),
              (i = h(i, s, n, r, t[15], 3634488961, 14)),
              (r = h(r, i, s, n, t[4], 3889429448, 20)),
              (n = h(n, r, i, s, t[9], 568446438, 5)),
              (s = h(s, n, r, i, t[14], 3275163606, 9)),
              (i = h(i, s, n, r, t[3], 4107603335, 14)),
              (r = h(r, i, s, n, t[8], 1163531501, 20)),
              (n = h(n, r, i, s, t[13], 2850285829, 5)),
              (s = h(s, n, r, i, t[2], 4243563512, 9)),
              (i = h(i, s, n, r, t[7], 1735328473, 14)),
              (n = f(
                n,
                (r = h(r, i, s, n, t[12], 2368359562, 20)),
                i,
                s,
                t[5],
                4294588738,
              ...
              (s = f(s, n, r, i, t[8], 2272392833, 11)),
              (i = f(i, s, n, r, t[11], 1839030562, 16)),
              (r = f(r, i, s, n, t[14], 4259657740, 23)),
              (n = f(n, r, i, s, t[1], 2763975236, 4)),
              (s = f(s, n, r, i, t[4], 1272893353, 11)),
              (i = f(i, s, n, r, t[7], 4139469664, 16)),
              (r = f(r, i, s, n, t[10], 3200236656, 23)),
              (n = f(n, r, i, s, t[13], 681279174, 4)),
              (s = f(s, n, r, i, t[0], 3936430074, 11)),
              (i = f(i, s, n, r, t[3], 3572445317, 16)),
              (r = f(r, i, s, n, t[6], 76029189, 23)),
              (n = f(n, r, i, s, t[9], 3654602809, 4)),
              (s = f(s, n, r, i, t[12], 3873151461, 11)),
              (i = f(i, s, n, r, t[15], 530742520, 16)),
              (n = c(
                n,
                (r = f(r, i, s, n, t[2], 3299628645, 23)),
                i,
                s,
                t[0],
                4096336452,
              ...
              (s = c(s, n, r, i, t[7], 1126891415, 10)),
              (i = c(i, s, n, r, t[14], 2878612391, 15)),
              (r = c(r, i, s, n, t[5], 4237533241, 21)),
              (n = c(n, r, i, s, t[12], 1700485571, 6)),
              (s = c(s, n, r, i, t[3], 2399980690, 10)),
              (i = c(i, s, n, r, t[10], 4293915773, 15)),
              (r = c(r, i, s, n, t[1], 2240044497, 21)),
              (n = c(n, r, i, s, t[8], 1873313359, 6)),
              (s = c(s, n, r, i, t[15], 4264355552, 10)),
              (i = c(i, s, n, r, t[6], 2734768916, 15)),
              (r = c(r, i, s, n, t[13], 1309151649, 21)),
              (n = c(n, r, i, s, t[4], 4149444226, 6)),
              (s = c(s, n, r, i, t[11], 3174756917, 10)),
              (i = c(i, s, n, r, t[2], 718787259, 15)),
              (r = c(r, i, s, n, t[9], 3951481745, 21)),
              (this._a = (this._a + n) | 0),
              (this._b = (this._b + r) | 0),
              (this._c = (this._c + i) | 0),
              (this._d = (this._d + s) | 0);
      ...
      i(p, o),
        (p.prototype._update = function () {
          ...
          for (
            ...
            var x, O;
            T < 16
              ? ((x = g(n, r, i, o, p, t[a[T]], c[0], h[T])),
                (O = v(w, m, E, S, k, t[u[T]], l[0], f[T])))
              : T < 32
              ? ((x = y(n, r, i, o, p, t[a[T]], c[1], h[T])),
                (O = b(w, m, E, S, k, t[u[T]], l[1], f[T])))
              : T < 48
              ? ((x = _(n, r, i, o, p, t[a[T]], c[2], h[T])),
                (O = _(w, m, E, S, k, t[u[T]], l[2], f[T])))
              : T < 64
              ? ((x = b(n, r, i, o, p, t[a[T]], c[3], h[T])),
                (O = y(w, m, E, S, k, t[u[T]], l[3], f[T])))
              : ((x = v(n, r, i, o, p, t[a[T]], c[4], h[T])),
                (O = g(w, m, E, S, k, t[u[T]], l[4], f[T]))),
              (n = p),
              (p = o),
              (o = d(i, 10)),
              (i = r),
    ...
    function (t, e, n) {
      ...
      var l = function (t, e, n) {
        ...
        p = { createHmacSecret: n(13).a, epoch: null, step: 30, window: 0 };
      var d = function () {
        var t =
            arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
        ...
        O = (function (t) {
          function e() {
            ...
            return (
              ...
              ((t = S(this, k(e).call(this)))._defaultOptions = {
                epoch: null,
                step: 30,
                window: 0,
              }),
              (t._options = t._defaultOptions),
              t
            );
          }
          var n, r, i;
        ...
        z = (function (t) {
          function e() {
            ...
            return (
              ...
              ((t = Y(this, W(e).call(this)))._defaultOptions = {
                encoding: "hex",
                epoch: null,
                step: 30,
                window: 0,
      ...
      var H = new z(),
        ...
        V = n.n(K),
        X = n(31),
        $ = { createHmac: V.a, randomBytes: X.a };
      n.d(e, "authenticator", function () {
        ...
        (H.defaultOptions = { crypto: $ }),
        (w.defaultOptions = { crypto: $ }),
        (A.defaultOptions = { crypto: $ });
    },
  ]);
});
